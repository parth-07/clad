...
namespace clad {
  ...
  public:
    ...
    /// Returns an array_ref to a window starting at offset and having the
    /// specified size in the underlying array
    CUDA_HOST_DEVICE array_ref<T> get_window(std::size_t offset,
                                             std::size_t size) {
