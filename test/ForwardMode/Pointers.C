...
int main() {
  ...
  MEM_FN_TEST(d_memFnPtrPar); // CHECK-EXEC: 630.00
                              // CHECK-EXEC: 990.00
  ...
  MEM_FN_TEST(d_memFnPtrToPtr_1Par); // CHECK-EXEC: 630.00
                                     // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtr_1ParPar); // CHECK-EXEC: 630.00
                                        // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtr); // CHECK-EXEC: 630.00
                                     // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtrPar); // CHECK-EXEC: 630.00
                                        // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtrParPar); // CHECK-EXEC: 630.00
                                           // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtr_1); // CHECK-EXEC: 630.00
                                       // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtr_1Par); // CHECK-EXEC: 630.00
                                          // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtr_1ParPar); // CHECK-EXEC: 630.00
                                             // CHECK-EXEC: 990.00

  MEM_FN_TEST(d_memFnPtrToPtrToPtr_1ParParPar); // CHECK-EXEC: 630.00
                                                // CHECK-EXEC: 990.00
  ...
  NON_MEM_FN_TEST(d_nonMemFnPar); // CHECK-EXEC: 96.00
                                  // CHECK-EXEC: 350.00
  ...
  NON_MEM_FN_TEST(d_nonMemFnPtrToPtrPar); // CHECK-EXEC: 96.00
                                          // CHECK-EXEC: 350.00

  NON_MEM_FN_TEST(d_nonMemFnPtrToPtr_1); // CHECK-EXEC: 96.00
                                         // CHECK-EXEC: 350.00

  NON_MEM_FN_TEST(d_nonMemFnPtrToPtr_1Par); // CHECK-EXEC: 96.00
                                            // CHECK-EXEC: 350.00

  NON_MEM_FN_TEST(d_nonMemFnPtrToPtr_1ParPar); // CHECK-EXEC: 96.00
                                               // CHECK-EXEC: 350.00
  ...
  NON_MEM_FN_TEST(d_nonMemFnPtrToPtrToPtr_1Par); // CHECK-EXEC: 96.00
                                                 // CHECK-EXEC: 350.00

  NON_MEM_FN_TEST(d_nonMemFnPtrToPtrToPtr_1ParPar); // CHECK-EXEC: 96.00
                                                    // CHECK-EXEC: 350.00

  NON_MEM_FN_TEST(d_nonMemFnPtrToPtrToPtr_1ParParPar); // CHECK-EXEC: 96.00
                                                       // CHECK-EXEC: 350.00
