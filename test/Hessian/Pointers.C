...
// CHECK-NEXT:     nonMemFn_darg0_grad(i, j, hessianMatrix.get_window(0UL, 1UL), hessianMatrix.get_window(1UL, 1UL));
// CHECK-NEXT:     nonMemFn_darg1_grad(i, j, hessianMatrix.get_window(2UL, 1UL), hessianMatrix.get_window(3UL, 1UL));
// CHECK-NEXT: }
