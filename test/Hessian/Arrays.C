...
// CHECK-NEXT:     f_darg0_grad(i, j, hessianMatrix.get_window(0UL, 1UL), hessianMatrix.get_window(1UL, 2UL));
// CHECK-NEXT:     f_darg1_0_grad(i, j, hessianMatrix.get_window(3UL, 1UL), hessianMatrix.get_window(4UL, 2UL));
// CHECK-NEXT:     f_darg1_1_grad(i, j, hessianMatrix.get_window(6UL, 1UL), hessianMatrix.get_window(7UL, 2UL));
// CHECK-NEXT: }
...
// CHECK-NEXT:   g_darg0_grad(i, j, hessianMatrix.get_window(0UL, 1UL), hessianMatrix.get_window(1UL, 2UL));
// CHECK-NEXT:   g_darg1_0_grad(i, j, hessianMatrix.get_window(3UL, 1UL), hessianMatrix.get_window(4UL, 2UL));
// CHECK-NEXT:   g_darg1_1_grad(i, j, hessianMatrix.get_window(6UL, 1UL), hessianMatrix.get_window(7UL, 2UL));
// CHECK-NEXT: }
